...
function personalAssistant() {
    ...
    let message = "holiday" ? "Enjoy your holiday": "How is it going?";
    console.log(message)

    let message2 = "rainy" ? "Stay back to avoid the rain" : "How is it going?"
    console.log(message2)

    let message3 = "night"? "It's late into the night, you should rest": "How is it going?"
    console.log(message3)

    let message4 = "evening"? "It's time to retire for day, you should rest": "How is it going?"
    console.log(message4)

    let message5 = "weekend"? "Enjoy your weekend": "How is it going?"
